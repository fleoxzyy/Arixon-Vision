...
A lightweight, spatial computing camera overlay built with Python. Designed to run on low-end hardware (like Intel Celerons), Arixon Vision turns your webcam feed into an interactive Mixed-Reality interface, allowing you to browse the web entirely using hand gestures.
